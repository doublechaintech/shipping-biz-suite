...
public class PlatformJDBCTemplateDAO extends ShippingNamingServiceDAO implements PlatformDAO{
	...
	*/
    ...
    public SmartList<Platform> requestCandidatePlatformForProfile(ShippingUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
