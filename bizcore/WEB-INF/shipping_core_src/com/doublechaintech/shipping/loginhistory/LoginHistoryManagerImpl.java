...
public class LoginHistoryManagerImpl extends CustomShippingCheckerManager implements LoginHistoryManager {
	...
	protected void throwExceptionWithMessage(String value) throws LoginHistoryManagerException{
 	...
 	protected LoginHistory saveLoginHistory(ShippingUserContext userContext, LoginHistory loginHistory, String [] tokensExpr) throws Exception{	
 	...
 	protected LoginHistory saveLoginHistoryDetail(ShippingUserContext userContext, LoginHistory loginHistory) throws Exception{	

 		
 		return saveLoginHistory(userContext, loginHistory, allTokens());
 	}
 	
 	public LoginHistory loadLoginHistory(ShippingUserContext userContext, String loginHistoryId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LoginHistory searchLoginHistory(ShippingUserContext userContext, String loginHistoryId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LoginHistory present(ShippingUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens) throws Exception {
 	...
 	public LoginHistory loadLoginHistoryDetail(ShippingUserContext userContext, String loginHistoryId) throws Exception{	
 	...
 	public Object view(ShippingUserContext userContext, String loginHistoryId) throws Exception{	
 		LoginHistory loginHistory = loadLoginHistory( userContext, loginHistoryId, viewTokens());
 		return present(userContext,loginHistory, allTokens());
		
 	}
 	protected LoginHistory saveLoginHistory(ShippingUserContext userContext, LoginHistory loginHistory, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getLoginHistoryDAO().save(loginHistory, tokens);
 	}
 	protected LoginHistory loadLoginHistory(ShippingUserContext userContext, String loginHistoryId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfLoginHistory(loginHistoryId);
		userContext.getChecker().throwExceptionIfHasErrors( LoginHistoryManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(ShippingUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ShippingUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens){
	...
	public LoginHistory createLoginHistory(ShippingUserContext userContext,String fromIp, String description, String secUserId) throws Exception
	{
	...
	protected void checkParamsForUpdatingLoginHistory(ShippingUserContext userContext,String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LoginHistory clone(ShippingUserContext userContext, String fromLoginHistoryId) throws Exception{
		
		return userContext.getDAOGroup().getLoginHistoryDAO().clone(fromLoginHistoryId, this.allTokens());
	}
	
	public LoginHistory internalSaveLoginHistory(ShippingUserContext userContext, LoginHistory loginHistory) throws Exception 
	{
		return internalSaveLoginHistory(userContext, loginHistory, allTokens());

	}
	public LoginHistory internalSaveLoginHistory(ShippingUserContext userContext, LoginHistory loginHistory, Map<String,Object> options) throws Exception 
	{
	...
	public LoginHistory updateLoginHistory(ShippingUserContext userContext,String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingLoginHistory(userContext, loginHistoryId, loginHistoryVersion, property, newValueExpr, tokensExpr);
	...
	public LoginHistory updateLoginHistoryProperty(ShippingUserContext userContext,String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingLoginHistory(userContext, loginHistoryId, loginHistoryVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(ShippingUserContext userContext, String loginHistoryId, String anotherSecUserId) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUser(ShippingUserContext userContext, String loginHistoryId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(ShippingUserContext userContext, String loginHistoryId, String anotherLogin) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithLogin(ShippingUserContext userContext, String loginHistoryId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(ShippingUserContext userContext, String loginHistoryId, String anotherEmail) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithEmail(ShippingUserContext userContext, String loginHistoryId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(ShippingUserContext userContext, String loginHistoryId, String anotherMobile) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithMobile(ShippingUserContext userContext, String loginHistoryId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(ShippingUserContext userContext, String loginHistoryId, int loginHistoryVersion) throws Exception {
	...
	public LoginHistory forgetByAll(ShippingUserContext userContext, String loginHistoryId, int loginHistoryVersion) throws Exception {
		return forgetByAllInternal(userContext, loginHistoryId, loginHistoryVersion);		
	}
	protected LoginHistory forgetByAllInternal(ShippingUserContext userContext,
			String loginHistoryId, int loginHistoryVersion) throws Exception{
	...
	public void onNewInstanceCreated(ShippingUserContext userContext, LoginHistory newCreated) throws Exception{
