...
public class BaseForm extends GenericForm{
	...
	protected FormField cardNumberFromShippingAddress(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Card Number");
		field.setLocaleKey("shipping_address.card_number");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
	...
	protected FormField addressLine1FromShippingAddress(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Address Line1");
		field.setLocaleKey("shipping_address.address_line1");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
		field.setRequired(true);
		field.setPlaceholder("请填写Address Line1");
		return field;
	}

	protected FormField addressLine2FromShippingAddress(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Address Line2");
		field.setLocaleKey("shipping_address.address_line2");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
		field.setRequired(true);
		field.setPlaceholder("请填写Address Line2");
		return field;
	}

	protected FormField addressLine3FromShippingAddress(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Address Line3");
		field.setLocaleKey("shipping_address.address_line3");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
		field.setType("text");
		field.setRequired(true);
		field.setPlaceholder("请填写Address Line3");
		return field;
	}
	...
	protected FormField profileIdFromShippingAddress(String parameterName, String initValue){
		FormField field = new FormField();
		field.setLabel("Profile");
		field.setLocaleKey("shipping_address.profile");
		field.setParameterName(parameterName);
		field.setDefaultValue(initValue);
		field.setFieldGroup("基本信息");
